...
def allocate_capital(E_scr, S_scr, G_scr, A, sectors=None, stocks=None):
    ...
    prices_path = "F:/Blackrock-main/Main website/static/data/stock_prices.csv"    
    prices = pd.read_csv(prices_path, index_col='date', parse_dates=True)  

    #Read in esg score data:
    esg_path = "F:/Blackrock-main/Main website/static/data/stock_data.csv"
...
def get_portfolio(E_scr, S_scr, G_scr, A, sectors=None, stocks=None):
    ...
    allocations[['Allocations','Sectors']].to_csv('F:/Blackrock-main/Main website/static/data/portfolio.csv')
